            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.author.store') }}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Author name" name="name" tabindex="0"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Author Slug" name="slug" tabindex="0"
